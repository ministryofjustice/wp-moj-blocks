...
registerBlockType("mojblocks/hero", {
  ...
  edit: function edit(props) {
    ...
    var onChangeBackgroundImage = function onChangeBackgroundImage(imageObject) {
      var imageSizes = imageObject.sizes; // determine the image size displayed and outputted to the PHP frontend

      var image = imageSizes.hero.url.length > 0 || imageSizes.hero == undefined ? imageSizes.hero.url : imageSizes.full.url;
      setAttributes({
    ...
    return [Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(InspectorControls, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PanelBody, {
      title: __('Choose hero block background image', 'mojblocks'),
      initialOpen: true
