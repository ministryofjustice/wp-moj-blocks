...
/***/ "./src/custom-blocks/accordion/edit.js":
/*!*********************************************!*\
  !*** ./src/custom-blocks/accordion/edit.js ***!
  \*********************************************/
/***/ (() => {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./src/custom-blocks/accordion/edit.js");
...
registerBlockType('mojblocks/accordion', {
  ...
  edit: props => {
    ...
    return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
      ...
      help: controlLanguageWelsh ? 'Controls are in Welsh' : 'Controls are in English',
      checked: controlLanguageWelsh,
      onChange: newControlLanguageWelsh => setAttributes({
        controlLanguageWelsh: newControlLanguageWelsh
      })
    })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: 'govuk-accordion preview-welsh-' + controlLanguageWelsh + ' ' + className,
...
/* harmony import */ var _separator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./separator */ "./src/custom-blocks/separator/index.js");
/* harmony import */ var _quote__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./quote */ "./src/custom-blocks/quote/index.js");
/* harmony import */ var _intro__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./intro */ "./src/custom-blocks/intro/index.js");
/* harmony import */ var _reveal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./reveal */ "./src/custom-blocks/reveal/index.js");
/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./card */ "./src/custom-blocks/card/index.js");
/* harmony import */ var _banner__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./banner */ "./src/custom-blocks/banner/index.js");
/* harmony import */ var _latest_news__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./latest-news */ "./src/custom-blocks/latest-news/index.js");
/* harmony import */ var _featured_news__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./featured-news */ "./src/custom-blocks/featured-news/index.js");
/* harmony import */ var _featured_document__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./featured-document */ "./src/custom-blocks/featured-document/index.js");
/**
...
/***/ "./src/custom-blocks/separator/index.js":
/*!**********************************************!*\
  !*** ./src/custom-blocks/separator/index.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)('mojblocks/separator', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Separator', 'mojblocks'),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('A section break', 'mojblocks'),
  category: 'mojblocks',
  icon: 'minus',
  keywords: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('separator', 'mojblocks'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('section', 'mojblocks'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('break', 'mojblocks'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('moj', 'mojblocks')],
  attributes: {
    separatorBreakSize: {
      type: 'string'
    }
  ...
  edit: props => {
    ...
    const setSize = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('xl');
    const onChangeBreakSize = newBreakSize => {
      setAttributes({
        separatorBreakSize: newBreakSize
      });
      setSize(newBreakSize);
    };
    return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Size', 'mojblocks'),
      initialOpen: true
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelRow, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
      label: "Gap size",
      help: "",
      ...
      class: `govuk-section-break govuk-section-break--xl govuk-section-break--visible govuk-section-break--${separatorBreakSize}`
    })];
  },
  // return null as frontend output is done via PHP
  save: () => null
...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_4___default()(function () {
  (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.unregisterBlockType)('core/separator');
});
