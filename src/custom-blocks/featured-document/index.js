...
registerBlockType(metadata.name, {
   ...
   * render_callback_featured_document_block() as $content, and the PHP builds
   * the outer wrapper itself. Adding a wrapper here would double-wrap the
   * frontend markup and invalidate every featured document already saved in the
   * database.
   */
